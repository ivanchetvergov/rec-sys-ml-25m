                ...
                <header className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-8 py-4"
                    ...
                    <div className="flex items-center gap-8">
                        ...
                        <nav className="hidden md:flex items-center gap-6 text-sm text-zinc-300">
                            <a href="#" className="hover:text-white transition-colors font-medium text-white">Home</a>
                            <a href="#popular" className="hover:text-white transition-colors">Trending</a>
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div className="w-8 h-8 rounded bg-zinc-600 flex items-center justify-center text-sm font-bold cursor-pointer hover:bg-zinc-500 transition-colors">
                            U
                        </div>
                    </div>
                </header>
